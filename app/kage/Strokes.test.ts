...
describe('Strokes', () => {
  it('一画の参照なしの単純なデータが正しく解析できること', () => {
    const strokes = new Strokes({ data: testData.singleStrokeKageData });
  ...
  it('複数画の参照なしのデータが正しく解析できること', () => {
    const strokes = new Strokes({ data: testData.multipleStrokesKageData });
  ...
  it('1つの参照のみのデータが正しく解析できること', () => {
    const strokes = new Strokes({ data: testData.singleHasGlyphKageData });
  ...
  it('複数の参照のみで構成されるデータが正しく解析できること', () => {
    const strokes = new Strokes({ data: testData.multipleHasGlyphsOnlyKageData });
  ...
  it('参照を含む複数画のデータが正しく解析できること', () => {
    const strokes = new Strokes({ data: testData.hasGlyphAndMultipleStrokesKageData });
  ...
  it('重複した複数の参照画で構成されるデータが正しく解析できること', () => {
    const strokes = new Strokes({ data: testData.hasDuplicateGlyphsKageData });
